		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#jsonmodeldemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jsonmodeldemo-display": {
								"semanticObject": "jsonmodeldemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jsonmodeldemo",
									"url": sap.ui.require.toUrl("jsonmodeldemo")
								}
							}
						}
					}
